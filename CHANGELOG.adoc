...
== Unreleased (dev)
=== Added
* Run on babashka 1.13.223 or later. SNAPSHOT versions of Maven artifacts are not reported, and changelog and diff URLs are found only for artifacts in repositories that serve their POM without authentication.
